from PyQt5.QtWidgets import QMainWindow, QPushButton, QApplication, QLabel, QLineEdit, QFileDialog, QScrollArea, QStyle, QVBoxLayout, QWidget
from PyQt5.QtGui import QPixmap, QIcon
from PyQt5.QtCore import QSettings, QSize, Qt
import sys, os, subprocess

from gui import create_script
...
class MainWindow(QMainWindow):
    ...
    def browse_file(self):
        ...
        file_names, _ = QFileDialog.getOpenFileNames(self, "选择文件", "/", "Python Files (*.py);;All Files (*)", options=options)
        if file_names:
    ...
    def execute_script(self):
        ...
        # QMessageBox.information(self, "执行脚本", "脚本执行已开始，请稍候...")
        # 如果是单个文件的话执行单个文件
    ...
    def open_create_window(self):
        self.create_script_window = create_script()
